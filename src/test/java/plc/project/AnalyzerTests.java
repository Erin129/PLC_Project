...
public final class AnalyzerTests {
    ...
    private static Stream<Arguments> testMethod() {
        return Stream.of(
                ...
                Arguments.of("Valid Return (NEW)",
                        new Ast.Method("func", Arrays.asList(), Arrays.asList(), Optional.of("Integer"), Arrays.asList(
                                new Ast.Statement.Return(new Ast.Expression.Literal(BigInteger.ZERO))
                        )),
                        init(new Ast.Method("func", Arrays.asList(), Arrays.asList(), Optional.of("Integer"), Arrays.asList(
                ...
                Arguments.of("Valid Parameter Use (NEW)",
                        ...
                        init(new Ast.Method("func", Arrays.asList("x"), Arrays.asList("Integer"), Optional.empty(), Arrays.asList(
                                new Ast.Statement.Expression(init(new Ast.Expression.Function(Optional.empty(), "print", Arrays.asList(
                                        init(new Ast.Expression.Binary("+",
                                                init(new Ast.Expression.Access(Optional.empty(), "x"), ast -> ast.setVariable(new Environment.Variable("x", "x", Environment.Type.INTEGER, false, Environment.NIL))),
